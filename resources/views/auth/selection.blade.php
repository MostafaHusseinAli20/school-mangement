...
<head>
    ...
    <title>اختيار نوع تسجيل الدخول</title>
                    ...
                    <div style="border-radius: 15px;" class="col-lg-8 col-md-8 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            <div class="form-inline">
                                <a class="btn btn-default col-lg-3" href="{{route('login.show','student')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/images/student.png')}}">
                                    <p class="mt-2">طالب</p>
                                </a>
                                <a class="btn btn-default col-lg-3" href="{{route('login.show','parent')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/images/parent.png')}}">
                                    <p class="mt-2">ولي امر</p>
                                </a>
                                <a class="btn btn-default col-lg-3" href="{{route('login.show','teacher')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/images/teacher.png')}}">
                                    <p class="mt-2">معلم</p>
                                </a>
                                <a class="btn btn-default col-lg-3" href="{{route('login.show','admin')}}">
