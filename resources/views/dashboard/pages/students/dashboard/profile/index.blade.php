                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="{{ asset('assets/images/student.png') }}" alt="avatar" class="rounded-circle img-fluid"
                                style="width: 150px;">
                            <h5 style="font-family: Cairo" class="my-3">{{ $information->name }}</h5>
                            <p class="text-muted mb-1">{{ $information->email }}</p>
                            <p class="text-muted mb-4">{{ trans('trans.student') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('student.profile.update', $information->id) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('trans-student.student_name_ar') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('trans-student.student_name_en') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
