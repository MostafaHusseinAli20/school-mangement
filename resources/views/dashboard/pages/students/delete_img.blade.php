    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('trans.Delete_attachment')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('delete_attachment')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('trans.Delete_attachment_tilte')}}</h5>
