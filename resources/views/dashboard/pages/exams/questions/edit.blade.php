...
@section('title', __('trans.school_mangement_system') . ' | ' . __('trans.edit_question'))
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.update',$question->id) }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{ trans('trans.question_name') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{ trans('trans.answers') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{ trans('trans.right_answer') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>{{ trans('trans.quizze_name') }} : <span
