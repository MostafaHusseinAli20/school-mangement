            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('online_classes.create')}}" class="btn btn-success" role="button" aria-pressed="true">{{ trans('trans.add_onlineclass') }}</a>
                                <a class="btn btn-warning" href="{{route('online.indirect_create')}}">{{ trans('trans.add_indirect_onlineclass') }}</a>
