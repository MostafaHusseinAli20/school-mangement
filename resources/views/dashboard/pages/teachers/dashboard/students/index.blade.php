                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <a href="{{ route('students.create') }}" class="btn btn-success btn-sm" role="button"
                                        aria-pressed="true">{{ trans('trans.add_student') }}</a>
                                    <a href="{{ route('teacher.attendances') }}" class="btn btn-info btn-sm"
                                        role="button" aria-pressed="true">{{ trans('trans.attendance') }}</a>
                                </div>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('teacher.students.show', $student->id) }}"><i
                                                                        style="color: #ffc107"
                                                                        class="far fa-eye "></i>&nbsp;
                                                                    {{ trans('trans.show_data_student') }}
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
