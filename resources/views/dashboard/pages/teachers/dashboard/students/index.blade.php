                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item"
                                                               ...
                                                               href="#Delete_Student{{ $student->id }}"><i
                                                                    ...
                                                                    {{ trans('trans.delete_data_student') }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
