                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('teacher.profile.update', $information->id) }}" method="post"
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center mb-3">
                                    ...
                                    <label for="mainImage" class="image-upload-container">
                                        ...
                                        <img id="previewImage" alt="selected image"
                                            src="{{ $information->image ? asset("storage/$information->image") : asset('assets/images/teacher.png') }}"
                                            style="display: {{ $information->image || asset('assets/images/teacher.png') ? 'block' : 'none' }}"
                                            alt="teacher image">
                                    </label>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-2">{{ trans('trans-teacher.name_ar') }}</p>
                                    </div>
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-2">{{ trans('trans-teacher.name_en') }}</p>
                                    </div>
                                    <div class="col-sm-12">
                                        <p class="text-muted mb-0">
