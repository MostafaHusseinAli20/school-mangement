...
@section('title', __('trans.school_mangement_system') . ' | ' . __('trans.add_processing_fee'))
...
@section('content')
{{ trans('trans.exclude_fees') }}  : <label style="color: red; font-family: 'Cairo', sans-serif;">
    {{$student->name}}</label>
     <!-- row -->
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  type="hidden" name="grade_id"  value="{{$student->grades->id}}" class="form-control">
                                    <input  type="hidden" name="classe_id"  value="{{$student->classes->id}}" class="form-control">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ trans('trans.student_balance') }}: </label>
